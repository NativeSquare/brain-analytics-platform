...
- **Sprint 1 feedback**: The Provider will accommodate reasonable adjustments and refinements based on the Client's feedback from the Sprint 1 Demo, provided they fit within the Sprint 2 timeline. The Provider retains sole discretion over whether a requested change constitutes a refinement (included) or a scope addition (subject to the Scope Change Procedure). Changes that extend the Sprint duration or require significant new development will be flagged and handled per the governing Agreement.
